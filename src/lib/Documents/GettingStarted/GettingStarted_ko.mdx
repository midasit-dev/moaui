...
Plug-in Item에 대한 UI에 대한 기획과 Python 코드는 작성된 상태라 가정하고 절차를 소개 합니다.</p>

<br />
## 작성 절차
- <b>⚙️ 환경 설정</b> 작성된 UI를 테스트 하고 Python 코드 작성을 위한 환경을 설정 합니다.
- <b>🎨 UI 작성</b> UI 도구를 사용하여 작성하고 개발환경에서 테스트를 해봅니다.
- <b>🐍 Python 입히기</b> 작성한 Python 코드를 UI와 연결하여 테스트 해봅니다.
- <b>📦 빌드하기</b>
- <b>🚀 배포하기</b>
...
- [Python 설치](https://www.python.org/downloads) 최신 버젼 설치를 권장 합니다.
...
<Source
	code={`npx create-react-app my-test --template @midasit-dev/cra-template-moaui`}
	language="bash"
	dark
/>
