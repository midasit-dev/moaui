          ...
          <Box>
            <Stack direction={"row"}>
              ...
              <Box display="flex" flexDirection={"row"} justifyContent={"space-between"} sx={{paddingLeft:"0.7rem", paddingRight:"0.7rem"}}>
                <Button onClick={onClickVersionButton} sx={{ minWidth:"0rem", color:'#333333', '&.Mui-disabled': {color: '#00bfff', fontWeight:'bold'}, '&:hover':{color:'#000080', backgroundColor:"#bfbfbf"}}} disabled={version === 1 ? true : false}>
                  V1
                </Button>
                <Button onClick={onClickVersionButton} sx={{p:"0rem", minWidth:"0rem", color:'#333333', '&.Mui-disabled': {color: '#00bfff', fontWeight:'bold'}, '&:hover':{color:'#000080', backgroundColor:"#bfbfbf"}}} disabled={version === 2 ? true : false}>
                  V2
                </Button>
              </Box>
              <Box display="flex" flexDirection={"row"} justifyContent={"space-between"} sx={{paddingLeft:"0.7rem", paddingRight:"0.7rem"}}>
                <Button onClick={onClickCodeButton} sx={{ minWidth:"0rem", color:'#333333', '&.Mui-disabled': {color: '#00bfff', fontWeight:'bold'}, '&:hover':{color:'#000080', backgroundColor:"#bfbfbf"} }} disabled={openCode === false ? true : false}>
                  UI
                </Button>
                <Button onClick={onClickCodeButton} sx={{p:"0rem", minWidth:"0rem", color:'#333333', '&.Mui-disabled': {color: '#00bfff', fontWeight:'bold'}, '&:hover':{color:'#000080', backgroundColor:"#bfbfbf"} }} disabled={openCode === true ? true : false}>
                  Code
                </Button>
              </Box>
              <Box sx={{height:`${800}px`, overflowY:'scroll', width:"100%",mr:"1rem"}}>
                <DraggableComponents />
              </Box>
              </Stack>
              <Box sx={{ml:"1rem"}}>
