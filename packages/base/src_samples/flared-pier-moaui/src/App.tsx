				...
				<GuideBox spacing={2}>
					<Panel variant="shadow2" padding={2}>
						<GuideBox spacing={2}>
							...
							<Panel variant="strock" border='1px solid #ddd' padding={2}>
								<GuideBox spacing={2} width={550} center>
							...
							<Panel width="100%" variant="strock" border='1px solid #ddd' padding={2}>
								<GuideBox width={"100%"}>
									<Table width="100%">
										<TableHead>
											<TableRow>
					...
					<GuideBox width="100%" height={30} row horSpaceBetween verCenter>
						<CompRefresh />
						<Button
							color="negative"
							variant="contained"
