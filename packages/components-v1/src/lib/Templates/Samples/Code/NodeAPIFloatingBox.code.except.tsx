    ...
    <Moaui.Panel variant="box" relative width={896} height={808}>
      ...
      <Moaui.FloatingBox
        {...{
          ...
          width: 208,
          height: 160,
          guideBoxProps: { spacing: 1, center: true, width: "inherit", height: "inherit" },
        }}
      >
        <Moaui.TextFieldV2
          {...{
      ...
      >
        <Moaui.Button {...{ variant: "contained", disabled: false, width: "auto", color: "negative", loading: false }}>
          POST (Add)
        </Moaui.Button>
      </Moaui.FloatingBox>
      ...
      <Moaui.FloatingBox
        {...{
          ...
          width: 208,
          height: 160,
          guideBoxProps: { width: "inherit", height: "inherit", center: true, spacing: 1 },
        }}
      >
        <Moaui.TextFieldV2
          {...{
      ...
      <Moaui.FloatingBox
        {...{
          ...
          width: 160,
          height: 160,
          guideBoxProps: { width: "inherit", height: "inherit", spacing: 1, horRight: true, center: true },
        }}
      >
        <Moaui.TextFieldV2
          {...{
      ...
      <Moaui.FloatingBox
        {...{
          ...
          width: 864,
          height: 48,
          guideBoxProps: { width: "inherit", height: "inherit", row: true, horSpaceBetween: true, verCenter: true },
        }}
      >
        <Moaui.Typography variant="h1" size="large">
          GET
