...
class MidasAPI:
    ...
    def put_Rigid_Link(self, existRigidLink):
        url = f'{self.base_url}/db/rigd'
        return requests_json.put(url, headers=self.headers, jsonObj={'Assign': existRigidLink})
    
    def post_Rigid_Link(self, newRigidLink):
        url = f'{self.base_url}/db/rigd'
        return requests_json.post(url, headers=self.headers, jsonObj={'Assign': newRigidLink})
# function ##########################################################################################################
